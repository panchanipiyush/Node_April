...
const addUser = () => {
    ...
    const user = new User({ uname:"piyush",email: "piyush@gmail.com", pass: "test123", age: 65 });
...
const addmanyUser = () => {
    ...
    const user1 = new User({ uname: "jay", email: "jay1@gmail.com", pass: "test123", age: 25 })
...
const deletedata = async () =>{
    try {
        ...
        const data = await User.findByIdAndDelete("64660d6e5c42e2b9e01f90bb")
        console.log(data);
    } catch (error) {
        console.log(error);
    }
